...
<head>
    ...
    <script>
        // -------------------------------------------------------------
        // 1. SIMULACIÓN DE LA API Y REQUISITOS DEL PROFESOR
        // -------------------------------------------------------------
        const respuestaAPI = {
            "status": 200,
        ...
        // Imprimir productos en consola (Requisito profesor)
        respuestaAPI.data.forEach((producto) => {
            console.log(`${producto.nombre} - $${producto.precio}`);
        });

        // Ejemplos de tipos de datos (Requisito profesor)
        let variable1 = null;
        ...
        // Control de errores (Requisito profesor)
        try { 
        ...
        // -------------------------------------------------------------
        // 2. LÓGICA DE CARGA DINÁMICA DEL PRODUCTO
        // -------------------------------------------------------------
        const idProducto = 4; // ID del producto actual
        let productoActual;
        ...
        function cargarProducto() {
            try {
                ...
                // ====================================================================
                // CREACIÓN DE LA LISTA DESPLEGABLE (SELECT) CON JAVASCRIPT
                // ====================================================================
                const contenedorContador = document.getElementById("contenedor-contador");
                contenedorContador.innerHTML = ""; // Limpiamos contenedor
                ...
                selectCantidad.className = "form-select cantidad"; // Usamos form-select de Bootstrap
                
                // Si no hay stock, deshabilitamos el select
                if(productoActual.stock === 0) {
                    ...
                    // CICLO FOR: Creamos las opciones desde el 1 hasta el stock máximo
                ...
                // Agregar elementos al contenedor en el HTML
...
<body onload="cargarProducto(); actualizarCarrito();">
    ...
    <!-- NAVBAR PARA ACCEDER AL CARRITO DESDE CUALQUIER LADO -->
...
<div class="producto-detalle">
    <div class="row align-items-center">
        ...
        <div class="col-md-5 contenedor-imagen">
            <img src="./fotos/tralalero.png" class="imagen-producto" alt="Tralalero Tralala">
        </div>
        ...
        <div class="col-md-7 informacion">
            ...
            <p class="descripcion">
                Nuestro cuarto y último producto, Tralalero Tralala, es un brainrot elaborado completamente a mano. 
                Cuenta con un diseño exclusivo y único, existiendo solamente 10 unidades.
            </p>
            <p class="descripcion">
                Tralalero Tralala mide aproximadamente 65 cm de alto y 45 cm de ancho. 
                Su peso es de 3,5 kg, lo que lo convierte en un brainrot liviano y fácil de transportar.
            </p>

            <!-- ZONA DE COMPRA -->
            <div class="zona-compra">
                
                <!-- AQUÍ SE INYECTARÁ LA LISTA DESPLEGABLE CON JAVASCRIPT -->
...
<!-- ----------------------------------------------------------- -->
<!-- 3. LÓGICA DEL CARRITO CON MANEJO UNITARIO (+ y -)           -->
<!-- ----------------------------------------------------------- -->
<script>
    ...
    // Aumenta o disminuye de a 1 sin tener que borrar todo
