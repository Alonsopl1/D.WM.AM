...
<head>
    ...
    <script>
        ...
        const idProducto = 3; // ID ACTUALIZADO
        let productoActual;
...
<div class="producto-detalle">
    <div class="row align-items-center">
        <div class="col-md-5 contenedor-imagen">
            <img src="./fotos/ballerina.png" class="imagen-producto" alt="Ballerina Cappuccina">
        </div>
        ...
        <div class="col-md-7 informacion">
            ...
            <p class="descripcion">
                Nuestro tercer producto, Ballerina Cappuccina, es una figura coleccionable fabricada con materiales delicados pero de alta calidad. Además de la figura, incluye una pequeña pista de baile especialmente diseñada para complementar su presentación y hacerla destacar dentro de la colección.
            </p>
            <p class="descripcion">
                Ballerina Cappuccina mide aproximadamente 60 cm de alto y 40 cm de ancho. Su peso es de aproximadamente 3,5 kg, por lo que resulta liviana y fácil de transportar. La pista de baile incluida mide aproximadamente 10 cm de alto y 40 cm de ancho y está elaborada con materiales reciclados de buena calidad.
            </p>
